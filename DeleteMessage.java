...
public class DeleteMessage extends javax.swing.JFrame {
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        String sql = "delete from message where MsgTitle='"+titleCbox.getSelectedItem()+"';";
        try{
            DbConnection db = new DbConnection();
            db.stm = db.con.createStatement();
            int val = JOptionPane.showConfirmDialog(null, "Are you sure,Do you want to delete this message?");
            if(val==0) {  
                db.stm.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "One message is deleted");
            }
        }catch(Exception ex){System.out.println("Solution!!!: "+ ex.getMessage());}
...
//            java.util.logging.Logger.getLogger(DeleteMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
